...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.write("")
        #kup bilety
        buyTicket=Button(rightFrame,height=3,text="Kup Bilety", bg="green")
        ...
        # usuwanie biletow
        returnTicket = Button(rightFrame, height=3, text="Usuń bilet", bg="green")
        returnTicket.pack(anchor=N, fill=X)


        #exit button
        self.quit = Button(rightFrame, text="Wyjście",bg="red", fg="white",height=2, width=20,
    ...
    def popupmsg(self,msg):
        ...
        B1 = Button(popup, text="Zamknij",font=("Verdana",17),bg="#6d6e70",fg="red",height=3, command=popup.destroy)
